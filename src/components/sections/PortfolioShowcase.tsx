...
// Fallback data reflecting your network & software engineering profile
const fallbackProjects = [
  {
    id: '1',
    title: 'Enterprise OSPF & NAT Network Architecture',
    description: 'Designed and simulated a multi-area OSPF routing structure with NAT and ACL security rules.',
    image_url: '/assets/project1.png',
    live_url: 'https://github.com/Agnik-Chakraborty',
  },
  {
    id: '2',
    title: 'Python Network Scanner & Utility Tools',
    description: 'Automated network diagnostics and IP range validation tools developed in Python.',
...
const fallbackTechStack = [
  ...
  { id: '2', name: 'Networking (CCNA)', logo_url: '' },
  { id: '3', name: 'Ethical Hacking', logo_url: '' },
  { id: '4', name: 'React.js', logo_url: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg' },
  { id: '5', name: 'Next.js', logo_url: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original.svg' },
  { id: '6', name: 'Tailwind CSS', logo_url: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-original.svg' },
]
...
export default function PortfolioShowcase() {
  const {
    ...
    techStacks: fetchedTechStacks,
    loading,
  } = usePortfolio()

  const projects = fetchedProjects && fetchedProjects.length > 0 ? fetchedProjects : fallbackProjects
  const certificates = fetchedCertificates || []
  const techStacks = fetchedTechStacks && fetchedTechStacks.length > 0 ? fetchedTechStacks : fallbackTechStack
            ...
            {activeTab === 'certificates' && (
              <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6 px-1">
                {certificates.length > 0 ? (
                  ...
                  <p className="col-span-full text-center text-white/50 text-sm py-12">
                    Certificates will appear here once added to your database.
                  </p>
                )}
              </div>
            )}
                    ...
                    >
                      <div className="relative flex items-center justify-center">
                        ...
                        {item.logo_url ? (
                          ...
                          <div className="relative z-10 w-[56px] h-[56px] rounded-2xl bg-white/10 flex items-center justify-center text-xs font-bold text-white/70">
